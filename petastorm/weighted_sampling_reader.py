...
class WeightedSamplingReader(object):
    ...
    def __init__(self, readers, probabilities):
        ...
        :class:`~petastorm.weighted_sampling_reader.SamplingMixer` implements an iterator interface. Each time a
        new element is requested, one of the readers is selected, weighted by the matching probability. An element
        ...
        The following example shows how a :class:`~petastorm.weighted_sampling_reader.SamplingMixer` can be instantiated
