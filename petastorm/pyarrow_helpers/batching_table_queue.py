...
class BatchingTableQueue(object):
    def __init__(self, batch_size):
        """The class is a FIFO queue. Arrow tables are added to the queue. When read, rows are regrouped into Arrow tables
        of a fixed size specified during construction of the object. The order of the rows in the output tables is the
        same as the order of the rows in the input tables.
